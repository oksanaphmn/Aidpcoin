...
#ifndef AIDP_QT_AIDPAMOUNTFIELD_H
#define AIDP_QT_AIDPAMOUNTFIELD_H
...
/** Widget for entering aidp amounts.
  */
class AidpAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit AidpAmountField(QWidget *parent = 0);
...
#endif // AIDP_QT_AIDPAMOUNTFIELD_H
