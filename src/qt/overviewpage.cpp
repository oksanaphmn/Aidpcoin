...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(AidpUnits::AIDP),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->aidpBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->aidpBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(AidpUnits::formatWithUnit(unit, balance, false, AidpUnits::separatorAlways));
    ui->labelUnconfirmed->setText(AidpUnits::formatWithUnit(unit, unconfirmedBalance, false, AidpUnits::separatorAlways));
    ui->labelImmature->setText(AidpUnits::formatWithUnit(unit, immatureBalance, false, AidpUnits::separatorAlways));
    ui->labelTotal->setText(AidpUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, AidpUnits::separatorAlways));
    ui->labelWatchAvailable->setText(AidpUnits::formatWithUnit(unit, watchOnlyBalance, false, AidpUnits::separatorAlways));
    ui->labelWatchPending->setText(AidpUnits::formatWithUnit(unit, watchUnconfBalance, false, AidpUnits::separatorAlways));
    ui->labelWatchImmature->setText(AidpUnits::formatWithUnit(unit, watchImmatureBalance, false, AidpUnits::separatorAlways));
    ui->labelWatchTotal->setText(AidpUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, AidpUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("AIDP")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the AIDP balance grid from expanding and looking terrible when asset balance is hidden
