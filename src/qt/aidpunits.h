...
#ifndef AIDP_QT_AIDPUNITS_H
#define AIDP_QT_AIDPUNITS_H
...
/** Aidp unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AidpUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AidpUnits(QObject *parent);
...
typedef AidpUnits::Unit AidpUnit;

#endif // AIDP_QT_AIDPUNITS_H
