...
#include "config/aidp-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatAidpURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + AidpUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatAidpURI(info));
}
