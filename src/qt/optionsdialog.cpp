    ...
    mapper(0)
{
    ...
    ui->aidpAtStartup->setToolTip(ui->aidpAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->aidpAtStartup->setText(ui->aidpAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openAidpConfButton->setToolTip(ui->openAidpConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new AidpUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->aidpAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAidpConfButton_clicked()
{
