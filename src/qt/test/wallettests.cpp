...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<AidpAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_aidp-qt -platform xcb      # Linux
//     src/qt/test/test_aidp-qt -platform windows  # Windows
//     src/qt/test/test_aidp-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = AidpUnits::formatWithUnit(unit, balance, false, AidpUnits::separatorAlways);
    ...
    // Amount input
    AidpAmountField* amountInput = receiveCoinsDialog.findChild<AidpAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: aidp:")) != -1);
