...
#ifndef AIDP_QT_AIDPGUI_H
#define AIDP_QT_AIDPGUI_H
...
/**
  Aidp GUI main class. This class represents the main window of the Aidp UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AidpGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AidpGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~AidpGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a aidp wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QComboBox *comboAidpUnit = nullptr;
