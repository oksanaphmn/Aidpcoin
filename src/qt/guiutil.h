...
#ifndef AIDP_QT_GUIUTIL_H
#define AIDP_QT_GUIUTIL_H
...
/** Utility functions used by the Aidp Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "aidp:" URI into recipient object, return true on successful parsing
