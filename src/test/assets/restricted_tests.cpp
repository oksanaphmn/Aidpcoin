...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler aidp tx
        CScript aidpTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut aidpOut(1*COIN, aidpTransfer);
        ...
        mutTxTest1.vout.emplace_back(aidpOut);
        ...
        mutTxTest2.vout.emplace_back(aidpOut);
        ...
        mutTxTest3.vout.emplace_back(aidpOut);
        ...
        mutTxTest4.vout.emplace_back(aidpOut);
        ...
        mutTxTest5.vout.emplace_back(aidpOut);
        ...
        mutTxTest6.vout.emplace_back(aidpOut);
        ...
        mutTxTest7.vout.emplace_back(aidpOut);
        ...
        mutTxTest8.vout.emplace_back(aidpOut);
