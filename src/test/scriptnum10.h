...
#ifndef AIDP_TEST_SCRIPTNUM10_H
#define AIDP_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Aidp Core 0.10.0, for cross-comparison.
 */
public:
