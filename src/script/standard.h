...
#ifndef AIDP_SCRIPT_STANDARD_H
#define AIDP_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_AIDP_ASSET script that carries data
    /** AIDP END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a aidpcoin address
 */
...
/**
 * Generate a Aidp scriptPubKey for the given CTxDestination. Returns a P2PKH
