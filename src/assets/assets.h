...
#ifndef AIDPCOIN_ASSET_PROTOCOL_H
#define AIDPCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_AIDP_ASSET AIDPQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_AIDP_ASSET AIDPO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_AIDP_ASSET AIDPR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_AIDP_ASSET AIDPT
...
#endif //AIDPCOIN_ASSET_PROTOCOL_H
