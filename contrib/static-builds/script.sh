...
find ${DISTNAME}/bin -type f -executable -exec ../aidpcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../aidpcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/aidpcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/aidpcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
