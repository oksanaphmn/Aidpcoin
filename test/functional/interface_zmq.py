...
import os
import struct
from test_framework.test_framework import AidpTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(AidpTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that aidp has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("aidpd has not been built with zmq enabled.")
