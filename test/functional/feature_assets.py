...
class AssetTest(AidpTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="AIDP*", verbose=False, count=2, start=-2)
        ...
        aidp_assets = n0.listassets(asset="AIDP*", verbose=False, count=2, start=-2)
        assert_equal(len(aidp_assets), 2)
        assert_equal(aidp_assets[0], "AIDP2")
        assert_equal(aidp_assets[1], "AIDP3")
        self.sync_all()
