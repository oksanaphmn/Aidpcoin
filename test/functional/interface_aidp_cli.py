...
class TestAidpCli(AidpTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `aidp-cli getinfo`")
        ...
        self.log.info("Compare responses from `aidp-cli -getinfo` and the RPCs data is retrieved from.")
