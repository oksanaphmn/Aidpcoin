...
class WalletTest(AidpTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 AIDP from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 AIDP with subtract fee from amount
        ...
        # Sendmany 10 AIDP with subtract fee from amount
