...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AidpTestFramework
    pass

class ExampleTest(AidpTestFramework):
    # Each functional test is a subclass of the AidpTestFramework class.
    ...
    def custom_method(self):
        ...
        AidpTestFramework class so other tests can use it."""
