...
class TxnMallTest(AidpTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 AIDP:
        ...
        # First: use raw transaction API to send 1240 AIDP to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AIDP coin each
        ...
        # Node0's balance should be starting balance, plus 50AIDP for another
        ...
        # Node0's total balance should be starting balance, plus 100AIDP for 
