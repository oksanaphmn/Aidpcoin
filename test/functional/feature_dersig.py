...
class BIP66Test(AidpTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # aidpd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and aidpd produces more specific reject
            # reasons.
