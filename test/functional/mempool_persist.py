...
By default, aidpd will dump mempool on shutdown and
...
class MempoolPersistTest(AidpTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give aidpd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent aidpd from writing mempool.dat to disk. Verify that `savemempool` fails")
