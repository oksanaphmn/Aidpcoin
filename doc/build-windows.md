...
Below are some notes on how to build Aidp Core for Windows.
...
way. This will install to `c:\workspace\aidp`, for example:

    make install DESTDIR=/mnt/c/workspace/aidp
