Aidp Core version *2.1.0* is now available!!
==============

  <https://github.com/AidpProject/Aidpcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/AidpProject/Aidpcoin/commits/release_2.1.0>
